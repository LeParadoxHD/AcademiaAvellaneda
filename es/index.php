...
<html lang="es" oncontextmenu="return false">
	<head>
		...
		<title>Acadèmia Avellaneda - Inicio</title>
	</head>
	<body>
	<div id="banner-cookies">
		<div class="bottom-shadow"></div>
		<div class="cookies-text">
				<p>Utilizamos cookies para poder ofrecer la mejor experiencia al usuario, más concretamente:</p>
				<br>
					<ul class="lista_normal">
						<li>Recordar si se ha aceptado el aviso de Cookies. (expira 24h)</li>
						<li>Guardar el nombre de usuario y cerrar su sesión. (expira 24h)</li>
					</ul>
				<p>Si estas visualizando esta página web en modo local, es decir; "file:///" o 192.168.1.x, etc. Es muy probable que las cookies sean desactivadas por el propio navegador, para activar en modo local sigue estos pasos:</p>
				<br>
					<ul class="lista_normal">
						<li><b>Chrome:</b> Crea un acceso directo de Chrome y en las propiedades añádale el parámetro '--enable-file-cookies'.
						<li><b>Firefox:</b> Por defecto, al menos en la última versión (36), acepta la cookies locales, por lo que no es necesario ningún ajuste.
						<li><b>Internet Explorer:</b> Siii, a partir de Internet Explorer 11, acepta las Cookies locales solo dando un clic en "Permitir Cookies bloqueadas" cuando lo pregunte. Well Do It Microsoft!
						<li><b>Opera:</b> No se puede, se puede con la extensión 'EditThisCookie', pero no es plan de instalar extensiones para la correcta visualización de la web.</li>
					</ul>
		</div>
	...
	<div id="projects">
		<div id="container_projects">
			<ul>
				...
				<li><img src="img/dash.png" alt="dash-previews"><a id="plumb" href="http://david.consultoriamassaguer.es/" target="blank">Construcciones Plumb</a></li>
				<li>
	...
	<header id="web">
		<!-- Client Logo -->
			<a href="index.php"><img id="logo1" class="logo" alt="logo" src="img/logo.png"></a>
			...
			<nav class="main_nav">
				...
				<ul id="script" class="navigation">
					<li class="left"><a href="index.php"><span><img alt="home-icon" src="img/nav/home.png">Inicio</span></a></li>
					<li><a href="gallery.html"><span><img alt="gallery-icon" src="img/nav/gallery.png">Galería</span></a></li>
					<li><a href="curses.html"><span><img alt="curses-icon" src="img/nav/curses.png">Cursos</span></a>
					<!-- Menu LvL 2 -->
						<ul>
							<li><a href="curses.html#graphic_design"><span>Diseño gráfico</span></a>
							<!-- Menu LvL 3 -->
								<ul>
									<li class="lvl2_first"><a href="curses.html#graphic_design-easy"><span>Nivel Básico</span></a></li>
									<li class="lvl2_last"><a href="curses.html#graphic_design-advanced"><span>Nivel Avanzado</span></a></li>
								</ul>
							</li>
							<li><a href="curses.html#video"><span>Edición de video</span></a>
							<!-- Menu LvL 3 -->
								<ul>
									<li class="lvl2_first"><a href="curses.html#video-easy"><span>Nivel Básico</span></a></li>
									<li class="lvl2_last"><a href="curses.html#video-advanced"><span>Nivel Avanzado</span></a></li>
								</ul>
							</li>
							<li><a href="curses.html#audio"><span>Edición de audio</span></a>
							<!-- Menu LvL 3 -->
								<ul>
									<li class="lvl2_first"><a href="curses.html#audio-easy"><span>Nivel Básico</span></a></li>
									<li class="lvl2_last"><a href="curses.html#audio-advanced"><span>Nivel Avanzado</span></a></li>
								</ul>
							</li>
							<li class="double_height"><a href="curses.html#videogame"><span>Programación <br>de videojuegos</span></a>
							<!-- Menu LvL 3 -->
								<ul>
									<li class="lvl2_first"><a href="curses.html#videogame-easy"><span>Nivel Básico</span></a></li>
									<li class="lvl2_last"><a href="curses.html#videogame-advanced"><span>Nivel Avanzado</span></a></li>
								</ul>
							</li>
							<li class="double_height last_li"><a href="curses.html#html"><span>Programación Web</span></a>
							<!-- Menu LvL 3 -->
								<ul>
									<li class="lvl2_first"><a href="curses.html#html-easy"><span>Nivel Básico</span></a></li>
									<li class="lvl2_last"><a href="curses.html#html-advanced"><span>Nivel Avanzado</span></a></li>
								</ul>
							</li>
						</ul>
					</li>
					<li><a href="contact.html"><span><img alt="message-icon" src="img/nav/message.png">Contacto</span></a></li>
					<li><a href="about.html"><span><img alt="about-icon" src="img/nav/question.png">Acerca de..</span></a></li>
	...
	<div id="body_form" class="first_content">
			<div id="help_widget">
				<a href="https://github.com/LeParadoxHD/AcademiaAvellaneda" target="blank">Código fuente</a>
			</div>
			<div id="enc_title">
				<h1>¿Quiénes somos?</h1>
			...
			<div class="text">
				<div id="text-left">
					<p>Somos una acadèmia especializada en la enseñanza de los cursos con más futuro laboral en el mercado actual, llevamos 10 años enseñando y actualmente realizamos cursos de diseño gráfico, edición de vídeo y audio, y programación de videojuegos y HTML y CSS. Nuestra actual fama es dada por nuestro métodos de enseñanza y por ofrecer una salida laboral casi segura.</p>
				</div>
				<div id="text-right">
					<img alt="html5-logo" src="img/html5-logo.jpg">
				</div>
				<div id="text-both">
					<p>Tenemos grandes patrocinadores para poder enseñar todo lo que los alumnos necesitan para poder salir al mercado laboral, como; Cisco, Samsung, SONY, y otros.</p>
				</div>
			</div>
			...
			<!-- Contenido -->
			<ul id="details">
					<li><b>Nombre:</b> Acadèmia d’informàtica Avellaneda </li>
					<li><b>Dirección:</b> Carrer del mossos, 23</li>
					<li><b>Ciudad:</b> Badalona</li>
					<li><b>CIF:</b> B-65748243</li>
					<li><b>Telefono:</b> 93 460 37 52</li>
				</ul>
			</div>
					...
					<fieldset>
						<legend>DATOS</legend>
							<table>
								...
								<tr>
									<td id="first_td">
										<label for="enroll_name">Nombre:</label>
											<input type="text" value="" name="enroll_name" id="enroll_name" placeholder="Usuario" required>
										<label for="enroll_last_name">Apellidos:</label>
											<input type="text" value="" name="enroll_last_name" id="enroll_last_name" placeholder="Apellidos" required>
										<label for="enroll_name">DNI:</label>
											<input type="text" value="" name="enroll_dni" placeholder="DNI" id="enroll_dni" required>
									</td>
									<!-- Columna 2 -->
									<td id="second_td">
										<label class="now_curse" for="now_curse">Seleccione curso:</label>
											<select id="now_curse">
												<optgroup label="Diseño gráfico">
													<option value="graphic_simple">Nivel Básico</option>
 													<option value="graphic_advanced">Nivel Avanzado</option>
												<optgroup label="Edición de vídeo">
													<option value="graphic_simple">Nivel Básico</option>
 													<option value="graphic_advanced">Nivel Avanzado</option>
												<optgroup label="Edición de audio">
													<option value="graphic_simple">Nivel Básico</option>
 													<option value="graphic_advanced">Nivel Avanzado</option>
												<optgroup label="Programación de videojuegos">
													<option value="graphic_simple">Nivel Básico</option>
 													<option value="graphic_advanced">Nivel Avanzado</option>
												<optgroup label="Programación HTML y CSS">
													<option value="graphic_simple">Nivel Básico</option>
 													<option value="graphic_advanced">Nivel Avanzado</option>
											</select>
	...
	<div id="sidebar">
		<div id="right_menu">
			<!-- Inicio de sesión -->
				...
				<form onsubmit="return login() || active()" enctype="multipart/form-data" method="post">
					<label for="user">Usuario:</label>
						<input placeholder="Usuario" type="text" name="user" maxlength="20" id="user" value="" required>
					<label for="password">Contraseña:</label>
						<input placeholder="Contraseña" type="password" name="password" id="password" value="" required>
						<input type="submit" id="signin" value="Acceder">
				</form>
			...
			<!-- Cookies Ayuda -->
				<span id="display_cookies">¿Tienes problemas de Cookies?</span><br>
		...
		<footer id="copyright">
			...
			<span>Academia Avellaneda &copy;<br>Todos los derechos reservados.</span>
		</footer>
	</div>
	<div id="filled_footer">&nbsp;</div>
	<div id="cookie_warning">
		Usamos Cookies para mejorar la experiencia de usuario.<div id="accept_cookies">OK</div>
	</div>
