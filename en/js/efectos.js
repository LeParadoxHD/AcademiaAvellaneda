...
function login(){
	...
	alert("It has been logged correctly as "+usera+"!");
	location.reload();
};
...
if (typeof username !== 'undefined') {
    ...
    $('#script').append('<li id="custom_bg" class="right"><a href="profile.html"><span id="config_span"><img alt="config-icon" src="img/nav/config.png">Details</span></a></li>');
...
$('#user_active').get(0).innerHTML = "<b>User:</b> "+userp+ "";

// Alerta registro OK

function signup(){
	alert('It has been signup correctly!');
};
