...
<html lang="en" oncontextmenu="return false">
	...
	<div id="banner-cookies">
		...
		<div class="cookies-text">
				<p>We use cookies to provide the best user experience, more specifically:</p>
					<br>
					<ul class="lista_normal">
						<li>Remember if you have accepted the notice Cookies. (expires 24h)</li>
						<li>Save the user name and log out. (expires 24h)</li>
					</ul>
				<p>If you are viewing this site in local mode, ie; "file:///" or 192.168.1.x, etc. It is very likely that cookies are disabled by the browser to activate in local mode follow these steps: </p>
					<br>
					<ul class="lista_normal">
						<li><b>Chrome:</b> Create a shortcut for Chrome and add you in the properties parameter '--enable-file-cookies'.
						<li><b>Firefox:</b> By default, at least in the latest version (36), accepting the local cookies, so no adjustment is necessary.
						<li><b>Internet Explorer:</b> Yeah, from Internet Explorer 11 accepts only local Cookies giving a click on "Allow Blocked Cookies" when asked. Microsoft Well Do It!
						<li><b>Opera:</b> No one can, you can with the 'EditThisCookie' extension, but not plan to install extensions for the proper display of the web.</li>
					</ul>
		</div>
		...
		<!-- Client Logo -->
			...
			<nav class="main_nav">
				...
				<ul id="script" class="navigation">
					<li class="left"><a href="index.php"><span><img alt="home-icon" src="img/nav/home.png">Home</span></a></li>
	...
	<div id="sidebar">
		<div id="right_menu">
			...
			<!-- Cookies Ayuda -->
				<span id="display_cookies">¿Problems with Cookies?</span><br>
